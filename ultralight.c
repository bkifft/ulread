...
static const response_and_type KNOWN_ULTRALIGHTS_VERSIONS[] = {
	...
	{ { 0x00, 0x04, 0x04, 0x05, 0x02, 0x02, 0x13, 0x03 }, { "NTAG I2C plus 1k", 232, 6 } },		/* TODO: No support for SRAM passthrough */
	{ { 0x00, 0x04, 0x04, 0x05, 0x02, 0x02, 0x15, 0x03 }, { "NTAG I2C plus 2k", 232, 6 } },		/* TODO: No support for SRAM passthrough; and to get to 1912, can ulread have support for SECTOR SELECT? and, can we get to 1008 in sector 0 as AN11631 suggests? */
};
